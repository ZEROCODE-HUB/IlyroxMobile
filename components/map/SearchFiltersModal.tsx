  ...
  const handleSaveSearch = async () => {
    ...
    try {
      ...
      if (createLead) {
        ...
        console.log("📤 Enviando a Supabase (leads):", leadInsertData);
        ...
        if (leadError) {
          console.error("❌ Error Supabase (leads):", leadError);
      ...
      console.log(
        "📤 Enviando a Supabase (busquedas_guardadas):",
      ...
      console.log("✅ Búsqueda guardada con éxito:", searchData);
      ...
      console.error("❌ Error en handleSaveSearch:", error);
