...
DECLARE
  ...
  v_ag jsonb;
BEGIN
  -- 1. Cargar propiedad — solo si publicada, activa y no borrada
  ...
  -- 2. Resolver tipo_operacion y precio
  ...
  -- 3. Iterar busquedas guardadas activas
  FOR v_search IN
  ...
  LOOP
    ...
    -- Ignorar busquedas totalmente vacias
    ...
    -- ----------------------------------------------------------------
    -- FILTROS ESPECIALIZADOS (desde criterios_busqueda JSONB)
    -- ----------------------------------------------------------------
    ...
    -- ----------------------------------------------------------------
    -- Poligonos del mapa (point-in-polygon con PostGIS)
    -- ----------------------------------------------------------------
    ...
    -- ----------------------------------------------------------------
    -- SIMILAR (precio +/-15%, m2 >=85%, habitaciones/banos tolerancia 1)
    -- ----------------------------------------------------------------
