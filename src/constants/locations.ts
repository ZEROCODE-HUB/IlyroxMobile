...
export const COLONIAS_POR_MUNICIPIO: Record<string, string[]> = {
  // CDMX
  Cuauhtémoc: ["Roma Norte", "Roma Sur", "Condesa", "Juárez", "Centro"],
  "Miguel Hidalgo": ["Polanco", "Lomas de Chapultepec", "Anzures", "Pensil"],
  "Benito Juárez": ["Del Valle", "Narvarte", "Nápoles", "Portales"],
  Coyoacán: ["Coyoacán Centro", "Del Carmen", "Pedregal de Santo Domingo"],

  // Nuevo León
  Monterrey: ["Centro", "Tecnológico", "Cumbres", "San Jerónimo", "Mitras"],
  "San Pedro Garza García": [
    "Del Valle",
    "Fuentes del Valle",
    "Valle de San Ángel",
  ],
  Guadalupe: ["Contry", "Linda Vista", "Guadalupe Centro"],
  ...
  Zapopan: ["Puerta de Hierro", "Ciudad del Sol", "Valle Real"],

  // Querétaro
  Querétaro: ["Juriquilla", "Centro", "Milenio III", "Carretas"],
  Corregidora: ["El Pueblito", "Candiles", "Balvanera"],

  // Puebla
  Puebla: ["Centro Histórico", "Angelópolis", "La Paz", "Humboldt"],
  "San Andrés Cholula": ["Lomas de Angelópolis", "San Andrés Centro"],

  // Quintana Roo
  Solidaridad: ["Quinta Avenida", "Playacar", "Gonzalo Guerrero"],

  // Veracruz
  Veracruz: ["Reforma", "Centro", "Fraccionamiento Virginia"],
  "Boca del Río": ["Costa de Oro", "El Morro", "Mocambo"],

  // Yucatán
  Mérida: ["Centro", "Montejo", "Altabrisa", "Cholul"],
};
